  ...
  <div class="tabs">
    ...
    <div id="about">
      <div class="article">
        ...
        <p>
        To learn more about the creation of this site or to receive updates on its development schedule, please visit and subscribe to the development blog, <a href="https://annieswafford.wordpress.com/">"Anglophile in Academia"</a>.  Please email using the link at the bottom of the page to provide comments and feedback!
        </p>
